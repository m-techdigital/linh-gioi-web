...
def main() -> int:
    ...
    require_text("packages/content/src/fixtures.ts", [
        ...
        'WEB v1.17 nối các route public thành hành trình an toàn: Bắt đầu, world loop, download trust, trạng thái, hỗ trợ an toàn và performance đều dẫn đúng bước tiếp.',
        'WEB v1.17 cải thiện cohesion giữa các page, hierarchy CTA và routing conversion-safe',
        'Route continuity biến menu dài thành hành trình đọc',
        'Conversion-safe nghĩa là không hứa nhầm',
        'Không có funnel giả, không có artifact public và không có backend tài khoản/hỗ trợ.',
        'Không có entitlement, thanh toán, launcher, secure inbox hoặc moderation live.',
    ])
    ...
    forbid_text("packages/content/src/fixtures.ts", [
        ...
        'No fake funnel, no public artifact, no account/support backend.',
        'No entitlement, payment, launcher, secure inbox or live moderation claim.',
    ])
    ...
    require_text("tests/e2e/fe-news-route-continuity-real-ui-layout-v1186.spec.ts", [
        ...
        'Route continuity và bước tiếp an toàn rõ hơn', 'Bài viết giải thích route continuity và conversion-safe', 'toHaveCount(2)',
