...
def check_tests_docs() -> None:
    ...
    require_text("apps/web/src/components/PublicDesignTargetReference.tsx", ["PUBLIC_SUPPORT_HELP_TARGET", "Support help detailed design target", "support-help-detailed-design-target-v1132.png", "Public Support Help", "pathname === \"/support/help\""])
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", ["Current phase: WEB-FE-SUPPORT-HELP-DESIGN-TARGET-DENSITY-v1.132 WEB_CLOSED", "Next task: WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.133"])
    require_text("docs/execution/WEB-NEXT-ACTION.md", ["WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.133", "Design Target First", "Base UI/UX Layout", "browser/e2e", "Vietnamese"])
