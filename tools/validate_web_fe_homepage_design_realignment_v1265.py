...
def main():
 ...
 check('apps/web/src/components/PublicNavigation.tsx',['<ArtWordmark','revealOnFocus','Trang chủ','Điều hướng công khai Linh Giới Online'])
 ...
 check('apps/web/src/components/PublicSiteShell.tsx',['<MarketingFooter','Bản công khai chưa mở','label:"Lộ trình"'])
