...
def main() -> int:
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", [
        ...
        'Select `/performance`', '/tmp/community-onboarding-desktop-v1208.png', '/tmp/community-onboarding-mobile-v1208.png',
        'desktop hero bottom 372.75px', 'mobile hero bottom 514.86px', 'Real Browser UI/UX Layout First', 'Base First'
    ])
    require_text("docs/execution/WEB-NEXT-ACTION.md", [
        'WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.209', 'Current FE scope: select `/performance`',
