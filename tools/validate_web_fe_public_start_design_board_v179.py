...
def check_start_board() -> None:
    ...
    require_text("apps/web/src/app/start/page.tsx", ["lgo-start-design-board", "/game-art/design-boards/start-tutorial-gameplay-loop.svg", "Bảng tuyến hướng dẫn bắt đầu", "loading=\"eager\"", "Ảnh tham chiếu trò chơi", "không mở tải game hay backend tài khoản"])
    require_text("packages/ui/src/service-layout.css", ["v1.217 shared start overview layout", ".lgo-start-design-board", ".lgo-start-design-board img", "grid-template-columns: 1fr", "object-fit: cover"])
def check_tests_and_docs() -> None:
    ...
    require_text("tests/e2e/fe-public-start-design-board-v179.spec.ts", ["/start", "Bảng tuyến hướng dẫn bắt đầu", "/game-art/design-boards/start-tutorial-gameplay-loop.svg", "loading", "naturalWidth", "start horizontal overflow"])
