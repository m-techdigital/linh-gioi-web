...
def main() -> int:
    ...
    req("docs/execution/WEB-NEXT-ACTION.md", ["Real Browser UI/UX Layout First is Priority #1", "CSS must be managed by owner/role", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.170", "select `/guides/player-trust-release-guide` as the next single active page"])
    ...
    req("docs/execution/WEB-PROJECT-STATE.md", ["Current phase: WEB-FE-RELEASE-READINESS-REAL-UI-LAYOUT-v1.143 WEB_CLOSED", "Next task: WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.170"])
