...
def check_game_world_board() -> None:
    ...
    require_text("apps/web/src/app/game/page.tsx", ["WorldRouteJourney", "WorldAtlasStories", "lgo-game-world-design-board", "game-world-atlas-hub.svg", "lgo-game-world-boundary", "Lộ trình công khai", "Bản đồ thế giới là lộ trình khám phá công khai", "chưa phải bản đồ mở hoặc máy chủ thế giới thật"])
    require_text("packages/ui/src/service-layout.css", ["Shared game overview page layout for public world atlas surfaces", "WEB v1.120/v1.135 game world detailed design target density", ".lgo-gamepage-stack", ".lgo-world-route-section", ".lgo-world-atlas-section", ".lgo-game-world-boundary"])
