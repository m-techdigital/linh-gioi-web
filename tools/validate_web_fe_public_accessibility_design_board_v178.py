...
def check_accessibility_board() -> None:
    ...
    require_text("apps/web/src/app/accessibility/page.tsx", ["lgo-accessibility-design-board", "/game-art/design-boards/accessibility-readability-route-map.svg", "Bảng lộ trình đọc dễ thao tác Linh Giới", "loading=\"eager\"", "Board tham chiếu", "audit truy cập chính thức"])
    require_text("packages/ui/src/service-layout.css", ["Shared accessibility page layout", ".lgo-accessibility-design-board", ".lgo-accessibility-design-board img", "grid-template-columns: 1fr", "overflow-wrap: anywhere"])
def check_tests_and_docs() -> None:
    ...
    require_text("tests/e2e/fe-public-accessibility-design-board-v178.spec.ts", ["/accessibility", "Bảng lộ trình đọc dễ thao tác Linh Giới", "/game-art/design-boards/accessibility-readability-route-map.svg", "loading", "naturalWidth", "accessibility horizontal overflow"])
    for rel in ["docs/execution/specs/WEB-FE-PUBLIC-ACCESSIBILITY-DESIGN-BOARD-v1.78.md", "LGO-WEB-FE-PUBLIC-ACCESSIBILITY-DESIGN-BOARD-REPORT-v1.78.md", "HANDOFF-LGO-WEB-FE-PUBLIC-ACCESSIBILITY-DESIGN-BOARD-v1.78.md"]:
        require_text(rel, ["WEB-FE-PUBLIC-ACCESSIBILITY-DESIGN-BOARD-v1.78", "WEB_CLOSED", "browser/e2e", "No production auth", "No DB persistence", "No real Portal integration", "No real Ops/Admin mutation", "NO_ACCEPTED_BACKEND_CONTRACT"])
