...
def check_routes() -> None:
    require_order("apps/web/src/app/release/page.tsx", "<h1>Release narrative: từ content-ready tới closed test</h1>", "<ContentIaStartCta />")
    require_order("apps/web/src/app/release/readiness/page.tsx", "<h1>Release readiness: đọc gate trước khi kỳ vọng bản test</h1>", "<ContentIaStartCta />")
...
def check_tests_and_docs() -> None:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", ["WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.87", "browser/e2e"])
def main() -> int:
