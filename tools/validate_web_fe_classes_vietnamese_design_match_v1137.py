...
def check_tests_docs() -> None:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", ["WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.166", "select `/guides/player-safety-support-guide` as the next single active page"])
