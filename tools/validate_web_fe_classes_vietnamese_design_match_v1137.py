...
def check_tests_docs() -> None:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", ["WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.192", "select `/news/performance-copy-asset-budget-polish-started` as the next single active page"])
