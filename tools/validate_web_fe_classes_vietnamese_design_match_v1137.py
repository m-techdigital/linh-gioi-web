...
def check_tests_docs() -> None:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", ["WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.161", "select `/guides/support-and-community-guide` as the next single active page"])
