...
def check_tests_docs() -> None:
    ...
    require_text("tests/e2e/fe-game-world-vietnamese-first-flow-v1135.spec.ts", ["game world Vietnamese first-flow", "Thiết kế chi tiết thế giới", "mở trong tab mới", "Thế giới Linh Giới", "Linh Thành", "Âm Giới", "game first-flow visible copy should be Vietnamese", "desktop route strip should follow the hero", "first-flow should not show the old wireframe/reference board"])
