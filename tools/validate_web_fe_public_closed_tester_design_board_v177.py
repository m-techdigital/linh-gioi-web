...
def check_closed_tester_board() -> None:
    ...
    require_text("apps/web/src/app/release/tester-pack/page.tsx", ["lgo-closed-tester-design-board", "/game-art/design-boards/closed-tester-production-board.svg", "Board gói tester cộng đồng", "loading=\"eager\"", "Board tham chiếu", "không phải form đăng ký"])
...
def check_tests_and_docs() -> None:
    ...
    require_text("tests/e2e/fe-public-closed-tester-design-board-v177.spec.ts", ["/release/tester-pack", "Board gói tester cộng đồng", "/game-art/design-boards/closed-tester-production-board.svg", "loading", "naturalWidth", "closed tester horizontal overflow"])
