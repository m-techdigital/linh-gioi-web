...
def main() -> int:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.155")
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", "Current phase: WEB-FE-GAME-LOOP-REAL-UI-LAYOUT-v1.154 WEB_CLOSED")
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.155")
    ...
    require_text("docs/execution/WEB-TASK-LEDGER.md", "| WEB-FE-GAME-LOOP-REAL-UI-LAYOUT-v1.154 | WEB-FE | WEB_CLOSED |")
    return finish("WEB CURRENT STATE")
