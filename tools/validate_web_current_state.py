...
def main() -> int:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.139")
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", "Current phase: WEB-FE-JOURNEY-VIETNAMESE-DESIGN-MATCH-v1.138 WEB_CLOSED")
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.139")
    ...
    require_text("docs/execution/WEB-TASK-LEDGER.md", "| WEB-FE-JOURNEY-VIETNAMESE-DESIGN-MATCH-v1.138 | WEB-FE | WEB_CLOSED |")
    return finish("WEB CURRENT STATE")
