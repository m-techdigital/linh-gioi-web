...
def main() -> int:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.200")
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", "Current phase: WEB-FE-PATCH-NOTES-REAL-UI-LAYOUT-v1.199 WEB_CLOSED")
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.200")
    ...
    require_text("docs/execution/WEB-TASK-LEDGER.md", "| WEB-FE-PATCH-NOTES-REAL-UI-LAYOUT-v1.199 | WEB-FE | WEB_CLOSED |")
    return finish("WEB CURRENT STATE")
