...
def main() -> int:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.175")
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", "Current phase: WEB-FE-EVENTS-REAL-UI-LAYOUT-v1.174 WEB_CLOSED")
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.175")
    ...
    require_text("docs/execution/WEB-TASK-LEDGER.md", "| WEB-FE-EVENTS-REAL-UI-LAYOUT-v1.174 | WEB-FE | WEB_CLOSED |")
    return finish("WEB CURRENT STATE")
