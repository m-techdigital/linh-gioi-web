...
def main() -> int:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.215")
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", "Current phase: WEB-FE-STORY-REAL-UI-LAYOUT-v1.214 WEB_CLOSED")
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.215")
    ...
    require_text("docs/execution/WEB-TASK-LEDGER.md", "| WEB-FE-STORY-REAL-UI-LAYOUT-v1.214 | WEB-FE | WEB_CLOSED |")
    return finish("WEB CURRENT STATE")
