...
def main() -> int:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.187")
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", "Current phase: WEB-FE-NEWS-ROUTE-CONTINUITY-REAL-UI-LAYOUT-v1.186 WEB_CLOSED")
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.187")
    ...
    require_text("docs/execution/WEB-TASK-LEDGER.md", "| WEB-FE-NEWS-ROUTE-CONTINUITY-REAL-UI-LAYOUT-v1.186 | WEB-FE | WEB_CLOSED |")
    return finish("WEB CURRENT STATE")
