...
def main() -> int:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.176")
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", "Current phase: WEB-FE-PATCH-NOTES-REAL-UI-LAYOUT-v1.175 WEB_CLOSED")
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.176")
    ...
    require_text("docs/execution/WEB-TASK-LEDGER.md", "| WEB-FE-PATCH-NOTES-REAL-UI-LAYOUT-v1.175 | WEB-FE | WEB_CLOSED |")
    return finish("WEB CURRENT STATE")
