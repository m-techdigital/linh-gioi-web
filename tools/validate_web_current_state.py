...
def main() -> int:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.202")
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", "Current phase: WEB-FE-RELEASE-READINESS-REAL-UI-LAYOUT-v1.201 WEB_CLOSED")
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.202")
    ...
    require_text("docs/execution/WEB-TASK-LEDGER.md", "| WEB-FE-RELEASE-READINESS-REAL-UI-LAYOUT-v1.201 | WEB-FE | WEB_CLOSED |")
    return finish("WEB CURRENT STATE")
