...
def main() -> int:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.145")
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", "Current phase: WEB-FE-TESTER-PACK-REAL-UI-LAYOUT-v1.144 WEB_CLOSED")
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.145")
    ...
    require_text("docs/execution/WEB-TASK-LEDGER.md", "| WEB-FE-TESTER-PACK-REAL-UI-LAYOUT-v1.144 | WEB-FE | WEB_CLOSED |")
    return finish("WEB CURRENT STATE")
