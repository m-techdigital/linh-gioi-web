...
def main() -> int:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.216")
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", "Current phase: WEB-FE-CLASSES-REAL-UI-LAYOUT-v1.215 WEB_CLOSED")
    require_text("docs/execution/WEB-NEXT-ACTION.md", "WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.216")
    ...
    require_text("docs/execution/WEB-TASK-LEDGER.md", "| WEB-FE-CLASSES-REAL-UI-LAYOUT-v1.215 | WEB-FE | WEB_CLOSED |")
    return finish("WEB CURRENT STATE")
