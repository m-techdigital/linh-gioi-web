...
def check_tests_and_docs() -> None:
    ...
    require_text("tests/e2e/fe-public-journey-design-board-v180.spec.ts", ["/journey", "Journey session route flow board", "/game-art/design-boards/journey-session-route-flow.svg", "loading", "naturalWidth", "journey horizontal overflow"])
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", ["WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.81", "browser/e2e"])
def main() -> int:
