...
def check_docs():
 ...
 req('docs/execution/WEB-PROJECT-STATE.md',['Current phase: WEB-FE-START-VIETNAMESE-DESIGN-MATCH-v1.139 WEB_CLOSED','Next task: WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.167'])
