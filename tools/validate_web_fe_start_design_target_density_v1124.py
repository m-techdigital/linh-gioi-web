...
def check_tests_docs() -> None:
    ...
    require_text("packages/ui/src/service-layout.css", ["v1.217 shared start overview layout", ".lgo-startpage-stack", ".lgo-start-design-board", ".lgo-start-real-screenshot-panel"])
    require_text("apps/web/src/app/globals.css", ["WEB v1.217 public design reference must not dominate real page layout"])
