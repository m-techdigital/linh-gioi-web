...
def main() -> int:
    ...
    require_text("packages/content/src/fixtures.ts", [
        ...
        'WEB v1.18 làm rõ tín hiệu niềm tin, giai đoạn phát hành và điểm kiểm chứng',
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", [
        'WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.215',
        'Current FE scope: select `/classes`', 'Real Browser UI/UX Layout First', 'Base UI/UX Layout'
    ])
