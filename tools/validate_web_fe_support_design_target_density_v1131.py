...
def check_tests_docs() -> None:
    ...
    require_text("apps/web/src/components/PublicDesignTargetReference.tsx", ["PUBLIC_SUPPORT_TARGET", "Support detailed design target", "support-detailed-design-target-v1131.png", "Public Support", "pathname === \"/support\""])
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", ["Current phase: WEB-FE-SUPPORT-DESIGN-TARGET-DENSITY-v1.131 WEB_CLOSED", "Next task: WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.132"])
    require_text("docs/execution/WEB-NEXT-ACTION.md", ["WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.132", "Design Target First", "Base UI/UX Layout", "browser/e2e", "Vietnamese"])
