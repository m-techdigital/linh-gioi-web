...
def check_tests_docs() -> None:
    ...
    require_text("docs/execution/WEB-NEXT-ACTION.md", ["WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.150", "select `/community/onboarding` as the next single active page"])
