...
def check_page_and_css() -> None:
    require_text("apps/web/src/app/community/page.tsx", ["<PublicCommunityGallery/>", "@lgo-web/ui/community-layout.css"])
    require_text("apps/web/src/components/PublicCommunityExperience.tsx", [
        "plazaScreenshots", "Khung hình prototype Linh Thành", "MediaFrame",
        "/game-art/community/linh-thanh-plaza-npc-preview.png", "/game-art/community/linh-thanh-plaza-target-selector.png",
        'loading="lazy"', "Chưa có trò chuyện, diễn đàn hoặc bang hội", "Không đồng nghĩa đã mở dịch vụ cộng đồng",
        'target="_blank"', 'rel="noopener noreferrer"'
    ])
    require_text("packages/ui/src/community-layout.css", [
        ".lgo-runtime-gallery", "repeat(2,minmax(0,1fr))", "object-fit:contain", "grid-template-rows:max-content auto", "grid-template-columns:1fr"
    ])
def check_tests_and_docs() -> None:
    ...
    require_text("tests/e2e/fe-public-community-real-plaza-gallery-v191.spec.ts", ["/community", "Khung hình prototype Linh Thành", "Ảnh quảng trường Linh Thành với nhân vật hướng dẫn", "columnCount", "pageOverflow", "maxFont", "naturalWidth"])
