...
def main() -> int:
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", [
        ...
        'Select `/status`', '/tmp/release-tester-pack-desktop-v1202.png', '/tmp/release-tester-pack-mobile-v1202.png',
        'desktop hero bottom 401.98px', 'mobile hero bottom 573.80px', 'Real Browser UI/UX Layout First', 'Base First'
    ])
    require_text("docs/execution/WEB-NEXT-ACTION.md", [
        'WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.203', 'Current FE scope: select `/status`',
