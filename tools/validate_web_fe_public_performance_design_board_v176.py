...
def check_performance_board() -> None:
    ...
    require_text("apps/web/src/app/performance/page.tsx", ["lgo-performance-design-board", "/game-art/design-boards/performance-copy-budget-hud.svg", "Bảng HUD ngân sách hiệu năng public Linh Giới", "loading=\"eager\"", "Board tham chiếu", "chứng nhận đo lường"])
    require_text("packages/ui/src/service-layout.css", ["Shared performance page layout", ".lgo-performance-design-board", ".lgo-performance-design-board img", "grid-template-columns: 1fr", "overflow-wrap: anywhere"])
def check_tests_and_docs() -> None:
    ...
    require_text("tests/e2e/fe-public-performance-design-board-v176.spec.ts", ["/performance", "Bảng HUD ngân sách hiệu năng public Linh Giới", "/game-art/design-boards/performance-copy-budget-hud.svg", "loading", "naturalWidth", "performance horizontal overflow"])
    for rel in ["docs/execution/specs/WEB-FE-PUBLIC-PERFORMANCE-DESIGN-BOARD-v1.76.md", "LGO-WEB-FE-PUBLIC-PERFORMANCE-DESIGN-BOARD-REPORT-v1.76.md", "HANDOFF-LGO-WEB-FE-PUBLIC-PERFORMANCE-DESIGN-BOARD-v1.76.md"]:
        require_text(rel, ["WEB-FE-PUBLIC-PERFORMANCE-DESIGN-BOARD-v1.76", "WEB_CLOSED", "browser/e2e", "No production auth", "No DB persistence", "No real Portal integration", "No real Ops/Admin mutation", "NO_ACCEPTED_BACKEND_CONTRACT"])
