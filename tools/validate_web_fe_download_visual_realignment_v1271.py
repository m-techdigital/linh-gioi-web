...
def main():
 ...
 require('docs/execution/WEB-PROJECT-STATE.md','WEB-FE-DOWNLOAD-VISUAL-REALIGNMENT-v1.271 WEB_CLOSED','WEB-FE-DOWNLOAD-TRUST-VISUAL-REALIGNMENT-v1.272')
 require('docs/execution/WEB-NEXT-ACTION.md','WEB-FE-DOWNLOAD-TRUST-VISUAL-REALIGNMENT-v1.272','Download v1.271 checkpoint')
