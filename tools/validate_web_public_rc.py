...
def main() -> int:
    ...
    for rel in [
        "apps/web/src/app/layout.tsx", "apps/web/src/app/robots.ts", "apps/web/src/app/sitemap.ts",
        "apps/web/src/app/not-found.tsx", "apps/web/src/app/error.tsx", "apps/web/src/app/loading.tsx",
        "docs/execution/WEB-PERFORMANCE-BUDGET.md", "docs/execution/WEB-VISUAL-EVIDENCE-MATRIX.md",
