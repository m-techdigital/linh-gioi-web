...
def check_tests_docs() -> None:
    ...
    require_text("packages/ui/src/service-layout.css", ["v1.218 shared download availability layout", ".lgo-downloadpage-stack", ".lgo-download-readiness-target-panel", ".lgo-readiness-list"])
