...
def check_source():
 ...
 req('packages/ui/src/service-layout.css',['v1.219 shared download trust layout','.lgo-downloadtrustpage-stack .lgo-trust-panel','grid-template-columns: repeat(6, minmax(0, 1fr))'])
def check_docs():
 ...
 req('docs/execution/WEB-PROJECT-STATE.md',['Current phase: WEB-FE-DOWNLOAD-TRUST-VIETNAMESE-DESIGN-MATCH-v1.141 WEB_CLOSED','Next task: WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.221'])
 req('docs/execution/WEB-NEXT-ACTION.md',['WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT','as the next single active page'])
