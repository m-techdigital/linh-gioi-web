...
def check_source():
 ...
 req('apps/web/src/components/PublicReleaseReadinessHubSections.tsx',['Gate owner','Không chuyển wording sang phát hành','Bằng chứng:', 'Quy tắc public:', 'Tin cậy tải game'])
...
def check_docs():
 ...
 req('docs/execution/WEB-PROJECT-STATE.md',['Current phase: WEB-FE-DOWNLOAD-TRUST-VIETNAMESE-DESIGN-MATCH-v1.141 WEB_CLOSED','Next task: WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.143'])
 req('docs/execution/WEB-NEXT-ACTION.md',['WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.143','select `/release/readiness` as the next single active page'])
