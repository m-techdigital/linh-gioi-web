...
def check_story_fracture_board() -> None:
    ...
    require_text("apps/web/src/app/story/page.tsx", ["lgo-story-fracture-design-board", "/game-art/world/dong-mon-skyline.webp", "Dong Mon fracture story concept art", "loading=\"eager\"", "Story reference art", "không phải quest state live"])
...
def check_tests_and_docs() -> None:
    ...
    require_text("tests/e2e/fe-public-story-fracture-design-board-v184.spec.ts", ["/story", "Dong Mon fracture story concept art", "/game-art/world/dong-mon-skyline.webp", "loading", "naturalWidth", "story fracture horizontal overflow"])
