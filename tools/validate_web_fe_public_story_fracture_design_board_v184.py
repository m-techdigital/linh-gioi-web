...
def check_story_fracture_board() -> None:
    ...
    require_text("packages/ui/src/service-layout.css", ["v1.214 shared story overview layout for the public narrative route", ".lgo-story-fracture-design-board", ".lgo-story-fracture-design-board img", "grid-template-columns: 1fr", "overflow-wrap: anywhere", ".lgo-storypage-stack .lgo-story-hero .lgo-cinematic-copy h1", "clamp(2.22rem, 3.35vw, 3.2rem)", "clamp(1.82rem, 7vw, 2.1rem)"])
def check_tests_and_docs() -> None:
    ...
    require_text("tests/e2e/fe-public-story-fracture-design-board-v184.spec.ts", ["/story", "lgo-storypage-expanded-evidence > summary", "Ảnh ý tưởng Vết Nứt Đông Môn trong cốt truyện Linh Giới", "/game-art/world/dong-mon-skyline.webp", "loading", "naturalWidth", "story fracture horizontal overflow"])
