...
def main():
 ...
 if '"validate_web_fe_support_real_ui_layout_v1224.py"' not in state or '"validate_web_opt_support_entry_hierarchy_v1285.py"' not in state: ERRORS.append('v1.224 support validator not explicitly superseded by manifest authority v1.285')
 browser_authority=read('tools/web_active_suite_manifest_v1298.json')
 if '"fe-support-real-ui-layout-v1224.spec.ts"' not in browser_authority: ERRORS.append('historical v1.224 support browser layout missing from manifest supersession')
