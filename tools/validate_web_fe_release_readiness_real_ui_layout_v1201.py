...
def main() -> int:
    ...
    require_text("docs/execution/WEB-PROJECT-STATE.md", [
        ...
        'Select `/game/loop`', '/tmp/release-readiness-desktop-v1201.png', '/tmp/release-readiness-mobile-v1201.png',
        'desktop hero bottom 391.50px', 'mobile hero bottom 578.94px', 'Real Browser UI/UX Layout First', 'Base First'
    ])
    require_text("docs/execution/WEB-NEXT-ACTION.md", [
        'WEB-FE-ACCESSIBILITY-INTERACTION-AUDIT-v1.214', 'Current FE scope: select `/story`',
