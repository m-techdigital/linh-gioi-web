// v1.86 coverage: release trust routes start main content with the page h1 before CTA sections.
...
test.describe("public release heading priority", () => {
  for (const route of routes) {
    test(`${route.path} starts release content with the page h1`, async ({ page, isMobile }) => {
