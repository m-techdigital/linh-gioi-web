...
export default async function GuideDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const isCompactGuideFlow = isGateEntryGuide || isBeginnerTrainingLoopGuide || isDownloadReadinessGuide || isSupportCommunityGuide;
