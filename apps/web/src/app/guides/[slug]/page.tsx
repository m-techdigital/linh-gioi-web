...
export default async function GuideDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (entry.slug === "faq-search-helpfulness-guide") {
    return <WebAppShell><PublicFaqGuide entry={entry}/></WebAppShell>;
  }
