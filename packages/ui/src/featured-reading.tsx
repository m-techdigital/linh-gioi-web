...
export function FeaturedReading({ title, description, href, image }: {
  ...
  return <article className="lgo-library-featured lgo-release-frame">
    ...
    <div className="lgo-library-featured-copy">
      ...
      <h2>{title}</h2><details className="lgo-catalog-summary"><summary>Tóm tắt bài viết <span aria-hidden="true">+</span></summary><p>{description}</p></details><LinkButton href={href} tone="gold">Mở bài hướng dẫn <ReleaseIcon name="arrow"/></LinkButton>
    </div>
  </article>;
}
