...
Current visual checkpoint: v1.258 `/news/news-guide-detail-pages-started` verified; next v1.259 `/news/status-download-trust-polish-started` after delivery. Normal push, exact remote HEAD and verified ZIP/SHA256 required. Historical articles are not live game operations; no-JavaScript streaming remains open.
