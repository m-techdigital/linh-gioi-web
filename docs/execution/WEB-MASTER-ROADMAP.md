...
Current visual checkpoint: full-site visual realignment is active. `/game` v1.266, `/story` v1.267, `/classes` v1.268 and `/journey` v1.269 now use their dedicated target-driven compositions; next `/start` v1.270. Historical test closure is not visual acceptance.
