# WEB-FE-NEWS-VISUAL-RESPONSIVE-REAL-UI-LAYOUT-v1.179
...
Scope: complete only `/news/visual-responsive-polish-started` as the active page from WEB-NEXT-ACTION.

Goal: render a compact Vietnamese News Detail article page that explains the visual/responsive polish slice while preserving shared public shell coherence: same header, menu, footer, article rhythm, related-news flow and backend-boundary wording.

Implementation requirements:

- Reuse and refine the shared compact News Detail layout in `packages/ui/src/service-layout.css`.
