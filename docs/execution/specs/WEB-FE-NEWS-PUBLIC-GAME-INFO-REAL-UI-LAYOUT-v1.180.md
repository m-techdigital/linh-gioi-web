# WEB-FE-NEWS-PUBLIC-GAME-INFO-REAL-UI-LAYOUT-v1.180
...
Scope: complete only `/news/public-game-info-depth-started` as the active page from WEB-NEXT-ACTION.

Goal: render a compact Vietnamese News Detail article page that explains public game-info depth while preserving shared public shell coherence: same header, menu, footer, article rhythm, related-news flow and backend-boundary wording.
