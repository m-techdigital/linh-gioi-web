...
4. Do not move past `/news/public-ux-content-polish-started` until closure evidence exists:
...
6. If execution drifts, return to `/news/public-ux-content-polish-started`, inspect rendered layout, check Base First owners, modify the shared base where reusable, and continue until `/news/public-ux-content-polish-started` is closed.
