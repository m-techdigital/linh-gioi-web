...
4. Do not move past `/classes` until closure evidence exists:
...
6. If execution drifts, stop and reset to this page:
   ...
   - continue until `/classes` is closed.
