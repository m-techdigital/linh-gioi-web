...
4. Do not move past `/news/player-safety-support-faq-polish-started` until closure evidence exists:
...
6. If execution drifts, return to `/news/player-safety-support-faq-polish-started`, inspect rendered layout, check Base First owners, modify the shared base where reusable, and continue until `/news/player-safety-support-faq-polish-started` is closed.
