...
4. Do not move past `/news/visual-responsive-polish-started` until closure evidence exists:
...
6. If execution drifts, return to `/news/visual-responsive-polish-started`, inspect rendered layout, check Base First owners, modify the shared base where reusable, and continue until `/news/visual-responsive-polish-started` is closed.
